...
export function Button({
  ...
  return (
    <Component
      className={cn(
        "bg-transparent relative p-[1px] overflow-hidden flex items-center justify-center border-none",
        containerClassName
      )}
      style={{
    ...
    >
      ...
      >
        <MovingBorder duration={duration} rx="30%" ry="30%">
          <div
            className={cn(
              "h-20 w-20 opacity-[0.8] bg-[radial-gradient(#0052FF_40%,transparent_60%)]",
              borderClassName
            )}
          />
        </MovingBorder>
